...
if __name__ == '__main__':
        ...
        LINKS_CONTENT="/community/tutorials/"
        NAME_PROGRAM_FILE_JAVA="digitalocean.jar"
        NAME_LOG_EXPORT_RUN_JAVA="digitalocean.log"
...
# Đây là API của bot telegram
        API_TELEGRAM = 'https://api.telegram.org/bot5asd8:AAGseMcAbgY_ohst-d2-c-Sbtn589mYF5j2/sendMessage'
        CHAT_ID = '-138889927'
        LINKS_PAGE_WEB = 'https://www.digitalocean.com'

#       rm -rf
        os.system("rm -rf " + GET_PATH_CURRENT_EXECUTE_DIRECTORY + "/" + NAME_LOG_EXPORT_RUN_JAVA)

#       run application java
        os.system("java -jar " + GET_PATH_CURRENT_EXECUTE_DIRECTORY + "/" + NAME_PROGRAM_FILE_JAVA + " >> " + GET_PATH_CURRENT_EXECUTE_DIRECTORY + "/" + NAME_LOG_EXPORT_RUN_JAVA)
